...
class MageWorx_CustomOptions_Block_Core_Html_Select extends Mage_Core_Block_Html_Select {
    ...
    protected function _toHtml()
    {
        ...
        $html = '<select name="'.$this->getName().'" id="'.$this->getId().'" class="'
            .$this->getClass().'" " '.$this->getExtraParams().'>';
    ...
    protected function _optionToHtml($option, $selected=false) {
        ...
        $html = '<option title="'.(@$option['params']['image_path']).'" ' . $params . 'value="'.$this->htmlEscape($option['value']).'"'.$selectedHtml.'>'.$this->htmlEscape($option['label']).'</option>';
