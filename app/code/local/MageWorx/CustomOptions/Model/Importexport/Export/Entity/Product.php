...
class MageWorx_CustomOptions_Model_Importexport_Export_Entity_Product extends Mage_ImportExport_Model_Export_Entity_Product
{
    ...
    public function export() {
        ...
        $customOptCols        = array(
            ...
            '_custom_option_qnty_input', '_custom_option_is_enabled', '_custom_option_in_group_id',
            '_custom_option_is_dependent', '_custom_option_option_code',
            ...
            '_custom_option_row_in_group_id', '_custom_option_row_dependent_ids', '_custom_option_row_code'
        );
        ...
        foreach ($this->_storeIdToCode as $storeId => &$storeCode) {
            ...
            foreach ($options as $option) {
                ...
                if ($defaultStoreId == $storeId) {
                    ...
                    $row['_custom_option_option_code']   = $option['option_code'];
                ...
                if ($values = $option->getValues()) {
                    ...
                    if ($defaultStoreId == $storeId) {
                        ...
                        $row['_custom_option_row_code']  = $firstValue['code'];
                ...
                foreach ($values as $value) {
                    ...
                    if ($defaultStoreId == $storeId) {
                        ...
                        $row['_custom_option_row_code']  = $value['code'];
