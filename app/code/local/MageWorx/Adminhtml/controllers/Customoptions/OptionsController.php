                    ...
                    if (isset($value['values']) && is_array($value['values'])) {
                        ...
                        foreach ($value['values'] as $vKey => $val) {
                            if ($val['is_delete'] != 1) {
                                ...
                                if (isset($val['tier']) && is_array($val['tier'])) {
                                    foreach ($val['tier'] as $_arrKey => $_arrVal) {
                                        if ($_arrVal['delete'] == '1') {
                                            unset($val['tier'][$_arrKey]);
                                        }
                                    }
                                }
...
$storeOptions[$optionId]['in_group_id'] = $counter;
$counter++;
...
$defaultOptions[$k]['in_group_id'] = $counter; 
$counter++;
}
