    ...
    public function getOptionValues() {                
        ...
        if (!$this->_values) {
            ...
            foreach ($optionsArr as $option) {
                ...
                $value['block_title'] = $this->htmlEscape($option->getBlockTitle());
                ...
                if ($this->getProduct()->getStoreId() != '0') {
                    ...
                    $value['checkboxScopeBlockTitle'] = $this->getCheckboxScopeHtml($option->getOptionId(), 'block_title', is_null($option->getStoreBlockTitle()));
                    $value['scopeBlockTitleDisabled'] = is_null($option->getStoreBlockTitle()) ? 'disabled' : null;
                }
                ...
                if ($option->getGroupByType() == Mage_Catalog_Model_Product_Option::OPTION_GROUP_SELECT) {
                    ...
                    foreach ($option->getValues() as $_value) {
                        ...
                        $value['optionValues'][$i] = array(
                            ...
                            'code' => $this->htmlEscape($_value->getCode()),
                            'tier' => $_value->getTier(),
